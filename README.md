...
| [isaac-cli-proxy](https://github.com/slagyr/isaac-cli-proxy) | Remote CLI proxy, `isaac remote <url>/cli <command...>`, ships argv and pipes local stdio to a server `/cli` endpoint | — |
