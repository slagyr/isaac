---
name: architecture
description: Use this skill when organizing directories, designing namespace boundaries, or deciding what belongs at the top level. Covers Screaming Architecture, domain-as-interface seams (Ports & Adapters at the directory level), and implicit/explicit API pairs.
---
...
Use this skill whenever you are deciding where code belongs: introducing a new namespace, splitting an overgrown one, deciding what's public vs private at a directory boundary, or evaluating whether a layout reveals or obscures the system's purpose.

Principles for organizing code: directory layout, domain boundaries,
and public surfaces. The principles are domain-agnostic — apply them
to a healthcare system, an inventory tracker, a CLI tool, or any
other project.

Examples below use a fictional spaceship to ground each principle in
concrete code. The metaphor is incidental; substitute your own domain.
