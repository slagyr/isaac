(ns mdm.isaac.tool.mcp.protocol-spec
  "Specs for shared MCP protocol operations."
  (:require [mdm.isaac.tool.mcp.protocol :as sut]
...
(describe "MCP Protocol"
  ...
  (context "client state management"
    ...
    (it "updates client with session ID"
      (let [client (sut/create-client "https://api.example.com/mcp")
