---
# isaac-jrj0
title: Leg 2 — agent contributes its workers and resume/suspend as subsystems; server stops calling the agent by name
status: draft
type: feature
priority: high
tags:
