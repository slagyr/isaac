...
Scenarios to plan: a contributor manifest naming the old berth id is rejected at load with a message naming the new id; `modules list` shows isaac.http and no isaac.server.
