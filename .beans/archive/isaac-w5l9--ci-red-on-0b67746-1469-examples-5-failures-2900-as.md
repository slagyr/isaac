---
# isaac-w5l9
title: "CI red on 0b67746: 1469 examples, 5 failures, 2900 assertions"
status: completed
type: bug
priority: high
created_at: 2026-05-11T02:44:18Z
updated_at: 2026-05-11T18:07:34Z
---
...
- Commit: 0b677461048c8406147126713bfb179c99658e77
- Short SHA: 0b67746
- Branch: main
...
Summary:
1469 examples, 5 failures, 2900 assertions
...
Failures:
  ...
  1) Grep tool returns matching lines with file and line prefixes
     Expected: nil
          got: true (using =)
     /home/runner/work/isaac/isaac/spec/isaac/tool/grep_spec.clj:22

  2) Grep tool returns a clear no-matches result
     Expected: nil
          got: true (using =)
     /home/runner/work/isaac/isaac/spec/isaac/tool/grep_spec.clj:30

  3) Grep tool limits matches using a glob filter
     Expected: nil
          got: true (using =)
     /home/runner/work/isaac/isaac/spec/isaac/tool/grep_spec.clj:37

  4) Grep tool truncates output at the requested head limit
     Expected: nil
          got: true (using =)
     /home/runner/work/isaac/isaac/spec/isaac/tool/grep_spec.clj:44

  5) Grep tool returns count mode output per file
     Expected: nil
          got: true (using =)
     /home/runner/work/isaac/isaac/spec/isaac/tool/grep_spec.clj:64

Finished in 1.81140 seconds
1469 examples, 5 failures, 2900 assertions
5 failures
```
