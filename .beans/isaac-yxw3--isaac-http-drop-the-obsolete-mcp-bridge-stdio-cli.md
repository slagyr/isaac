...
main-sha: isaac-http 76936f85fa98faf39bdb765f786139e292871dbe (0.1.25). Planner implemented and verified: bb ci 189/0 + 110/0. Removed src/isaac/mcp_bridge, its spec and features/server/mcp_bridge.feature; manifest CLI map is {:http}; README updated. Registry repinned from c08f69c.
