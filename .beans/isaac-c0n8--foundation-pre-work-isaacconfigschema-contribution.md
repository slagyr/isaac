...
updated_at: 2026-06-12T15:27:08Z
parent: isaac-brth
blocked_by:
    - isaac-niku
    - isaac-wop6
...
- [x] Extract foundation utilities: new src/isaac/config/schema_base.clj with
...
- [x] Declare :isaac.config/schema in the foundation manifest (no :factory —
...
- [x] Server manifest contributes fragments + descriptors for every current
...
- [x] Loader composes: base root + requiring-resolve'd fragments
...
- [x] Derive entity-kind knowledge from descriptors instead of literals:
