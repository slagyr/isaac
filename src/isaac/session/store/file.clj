...
(defn append-message!
  ...
  ([state-dir identifier message fs]
   (c/append-message! get-session get-transcript update-sidecar-entry! now-iso state-dir identifier message fs)))
...
(defn append-error!
  ...
  ([state-dir identifier error-entry fs]
   (c/append-error! get-session get-transcript update-sidecar-entry! now-iso state-dir identifier error-entry fs)))
...
(defn append-compaction!
  ...
  ([state-dir identifier compaction fs]
   (c/append-compaction! get-session get-transcript update-sidecar-entry! now-iso state-dir identifier compaction fs)))

(defn splice-compaction!
  ([state-dir identifier compaction]
   (splice-compaction! state-dir identifier compaction (runtime-fs!)))
  ([state-dir identifier compaction fs]
   (c/splice-compaction! get-session get-transcript update-sidecar-entry! now-iso state-dir identifier compaction fs)))
